...
//        when(debitCardDAO.saveDebitCard(any(DebitCardDTO.class))).thenReturn(expected);
//
//        // When
...
//        verify(debitCardDAO).saveDebitCard(any(DebitCardDTO.class));
//    }
//
//    @Test
...
//
//        when(userDAO.isPassportNumberAvailable(passport)).thenReturn(false);
//        doNothing().when(debitCardDAO).updateDebitCard(any(DebitCardDTO.class));
//
//        // When
//        debitCardServiceImpl.updateDebitCard(id, passport, cardNumber, cardNumber, cvv, TEN, expirationDate, issueDate);
//
//        // Then
//        verify(debitCardDAO).updateDebitCard(any(DebitCardDTO.class));
//        verify(userDAO).isPassportNumberAvailable(passport);
//    }
//
//    @Test
