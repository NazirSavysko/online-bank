...
//        when(userDAO.saveUser(any(UserDTO.class))).thenReturn(expectedUser);
//
//        // When
...
//        verify(userDAO).saveUser(any(UserDTO.class));
//    }
//
//    @Test
...
//        final String name = "John Doe";
//        when(userDAO.updateUser(any(UserDTO.class))).thenReturn(true);
//
//        // When
...
//        // Then
//        assertTrue(result);
//        verify(userDAO).updateUser(any(UserDTO.class));
//    }
//
//    @Test
