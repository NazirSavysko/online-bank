...
//        // Given
//        final AutoLoanDTO autoLoan = mock(AutoLoanDTO.class);
//        final List<AutoLoanDTO> mockAutoLoans = List.of(autoLoan);
...
//        when(autoLoanDAO.saveAutoLoan(any(AutoLoanDTO.class))).thenReturn(expectedLoan);
//
//        // When
...
//        verify(autoLoanDAO).saveAutoLoan(any(AutoLoanDTO.class));
//    }
//
//    @Test
...
//
//        when(userDAO.isPassportNumberAvailable(passport)).thenReturn(false);
//        when(autoLoanDAO.updateAutoLoan(any(AutoLoanDTO.class))).thenReturn(true);
//
//        // When
...
//        assertTrue(result);
//        verify(userDAO).isPassportNumberAvailable(passport);
//        verify(autoLoanDAO).updateAutoLoan(any(AutoLoanDTO.class));
//    }
//
//    @Test
