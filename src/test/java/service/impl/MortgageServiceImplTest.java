...
//        when(mortgageDAO.saveMortgage(any(MortgageDTO.class))).thenReturn(expected);
//
//        // When
...
//        verify(mortgageDAO).saveMortgage(any(MortgageDTO.class));
//    }
//
//    @Test
...
//
//        when(userDAO.isPassportNumberAvailable(passport)).thenReturn(false);
//        when(mortgageDAO.updateMortgage(any(MortgageDTO.class))).thenReturn(true);
//
//        // When
...
//        assertTrue(result);
//        verify(userDAO).isPassportNumberAvailable(passport);
//        verify(mortgageDAO).updateMortgage(any(MortgageDTO.class));
//    }
//
//    @Test
